...
- [ ] 2. データアクセス層の実装（Composables）
- [ ] 2.1 Firestore接続機能の構築
  - Firestore初期化関数の実装
  - データベースインスタンス取得機能の実装
  - 汎用クエリヘルパー関数の実装
...
- [ ] 10. Firebase Hostingセットアップとデプロイ準備
- [ ] 10.1 Firebase Hostingの設定
