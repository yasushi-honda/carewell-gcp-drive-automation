...
**現在の状態**: ✅ **Ver1リリース完了** - https://carewell-dashboard-2026.web.app
...
#### ファイル収集ジョブ（carewell-class系、16ジョブ）
...
| carewell-class10-task01 | №10 | 課題① | 30分毎 | ✅ ENABLED |
| carewell-class10-task02 | №10 | 課題② | 30分毎 | ✅ ENABLED |

#### 申し込み状況取得ジョブ（carewell-automation-pattern系、8ジョブ）⚠️絶対削除禁止
